        ...
        <div className="relative z-10 p-8">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="space-y-6">
              {linkTree.avatar_url && (
                <div 
                  className={`mx-auto ${(linkTree as any).format || 'rounded-full'} overflow-hidden border-4 border-white/20 shadow-2xl`}
                  style={{ 
                    width: (linkTree as any).size || '120px', 
                    height: (linkTree as any).size || '120px' 
                  }}
                >
  ...
  return (
    <div className="relative min-h-screen p-8" style={getCustomStyles()}>
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center space-y-8">
        ...
        {linkTree.avatar_url && (
          <div 
            className={`mx-auto ${(linkTree as any).format || 'rounded-full'} overflow-hidden border-4 border-white/20`}
            style={{ 
              width: (linkTree as any).size || '120px', 
              height: (linkTree as any).size || '120px' 
            }}
