...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav role="navigation" aria-label="Menu principal" className={`hidden md:block fixed top-0 left-0 right-0 ${isDark ? 'bg-black/60 text-white' : 'bg-[#f5f5f5]/60 text-black'} py-3 border-b ${isDark ? 'border-white/10' : 'border-gray-200'} w-full transition-colors duration-300 backdrop-blur-md`} style={{ zIndex: 99999999 }}>
