...
const ContactInfo: React.FC = () => {
  ...
  return (
    <div className={`${isDark ? 'bg-black/80 border-white/10 text-white' : 'bg-white/90 border-black/10 text-black'} p-4 border shadow-lg h-full rounded-lg backdrop-blur-sm`}>
