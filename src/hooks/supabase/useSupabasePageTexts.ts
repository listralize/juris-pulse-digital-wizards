    ...
    try {
      ...
      if (allSettings && allSettings.length > 1) {
        ...
        const loadedTexts: PageTexts = {
          ...
          heroPrimaryButtonText: (settings as any).hero_primary_button_text || defaultPageTexts.heroPrimaryButtonText,
          heroPrimaryButtonLink: (settings as any).hero_primary_button_link || defaultPageTexts.heroPrimaryButtonLink,
          heroSecondaryButtonText: (settings as any).hero_secondary_button_text || defaultPageTexts.heroSecondaryButtonText,
          heroSecondaryButtonLink: (settings as any).hero_secondary_button_link || defaultPageTexts.heroSecondaryButtonLink,
