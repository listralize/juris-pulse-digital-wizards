      ...
      try {
        ...
        const loadedData: PageTexts = {
          ...
          ...(settings && {
            ...
            heroPrimaryButtonText: (settings as any).hero_primary_button_text || pageTexts.heroPrimaryButtonText,
            heroPrimaryButtonLink: (settings as any).hero_primary_button_link || pageTexts.heroPrimaryButtonLink,
            heroSecondaryButtonText: (settings as any).hero_secondary_button_text || pageTexts.heroSecondaryButtonText,
            heroSecondaryButtonLink: (settings as any).hero_secondary_button_link || pageTexts.heroSecondaryButtonLink,
  ...
  const savePageTexts = async (newTexts: PageTexts) => {
    try {
      ...
      const siteData = {
        ...
        hero_primary_button_text: newTexts.heroPrimaryButtonText,
        hero_primary_button_link: newTexts.heroPrimaryButtonLink,
        hero_secondary_button_text: newTexts.heroSecondaryButtonText,
        hero_secondary_button_link: newTexts.heroSecondaryButtonLink,
