      ...
      try {
        ...
        const loadedData: PageTexts = {
          ...
          ...(settings && {
            ...
            heroPrimaryButtonText: settings.hero_primary_button_text || pageTexts.heroPrimaryButtonText,
            heroPrimaryButtonLink: settings.hero_primary_button_link || pageTexts.heroPrimaryButtonLink,
            heroSecondaryButtonText: settings.hero_secondary_button_text || pageTexts.heroSecondaryButtonText,
            heroSecondaryButtonLink: settings.hero_secondary_button_link || pageTexts.heroSecondaryButtonLink,
